...
api: 'POST https://bizchat.io/api/datastores/file-upload/generate-link/{datastoreId}'
...
```js
const apiUrl = 'https://bizchat.io/api';
const apiKey = 'XXX';
...
curl --location --request POST 'https://bizchat.io/api/datastores/file-upload/generate-link/<datastoreId>' \
