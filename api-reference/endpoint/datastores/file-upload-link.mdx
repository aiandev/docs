...
api: 'POST https://api.bizchat.io/datastores/file-upload/generate-link/{datastoreId}'
...
```js
const apiUrl = 'https://api.bizchat.io';
const apiKey = 'XXX';
...
curl --location --request POST 'https://api.bizchat.io/datastores/file-upload/generate-link/<datastoreId>' \
